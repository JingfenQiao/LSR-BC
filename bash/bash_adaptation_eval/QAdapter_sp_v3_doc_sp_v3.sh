...
#SBATCH --output=./log/adapter_new_sp_v3_old_sp_v3_doc_fusion_type_%a.output
#SBATCH --error=./log/adapter_new_sp_v3_old_sp_v3_doc_fusion_type_%a.output
...
adapter_model=(/ivi/ilps/personal/jkang1/jf/lsr-bc/ce_new_model_as_teacher_sp_v3_doc/epoch-10 ce_new_model_as_teacher_sp_v3_doc)
type=(5 7)
