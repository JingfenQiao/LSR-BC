...
#SBATCH --output=./log/ce_new_model_as_teacher_sp_v3_doc.output
#SBATCH --error=./log/ce_new_model_as_teacher_sp_v3_doc.output
...
CUDA_VISIBLE_DEVICES=0,1 python -u query_adapter/run_ce_new_model.py \
    ...
    --out_dir ./ce_new_model_as_teacher_sp_v3_doc \
    --num_negs 20 \
    --epochs 20