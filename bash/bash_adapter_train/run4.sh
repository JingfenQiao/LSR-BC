#!/bin/sh
#SBATCH -p gpu
#SBATCH --job-name=ce_new_model_as_teacher
#SBATCH --mem=60G
#SBATCH --time=60:00:00
#SBATCH --output=./log/ce_new_model_as_teacher.output
#SBATCH --error=./log/ce_new_model_as_teacher.output
...
CUDA_VISIBLE_DEVICES=0,1 python -u query_adapter/run_ce_new_model.py \
    ...
    --out_dir ./ce_new_model_as_teacher \
    --num_negs 20 \
    --epochs 20